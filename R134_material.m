...
for f = 1:length(fileNames)
    ...
    if strcmp(fileNames{f}, 'Wall Heat Flux.csv')
        ...
        xlabel('Cylinder Wall Normalized Position', 'Interpreter', 'latex', 'FontSize', baseFontSize * fontSizeMultiplier);  % Set x-label font size
    else
    ...
    title(sprintf('R134-a %s ', fileNames{f}(1:end-4)), 'Interpreter', 'latex', 'FontSize', baseFontSize * fontSizeMultiplier); % Set title font size
