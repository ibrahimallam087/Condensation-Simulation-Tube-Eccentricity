...
for f = 1:length(fileNames)
    ...
    title(sprintf('R134-a %s (Original)', fileNames{f}(1:end-4)), 'Interpreter', 'latex', 'FontSize', 18); % Set title font size to 18
    ...
    xlabel('Radial Position', 'Interpreter', 'latex', 'FontSize', 16);  % Set x-axis label size to 16
    ylabel(fileNames{f}(1:end-4), 'Interpreter', 'latex', 'FontSize', 16);  % Set y-axis label size to 16
    title(sprintf('R134-a %s (Zoomed)', fileNames{f}(1:end-4)), 'Interpreter', 'latex', 'FontSize', 18); % Set title font size to 18
    legend('show', 'Location', 'best');
